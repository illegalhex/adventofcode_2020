...
#[test]
fn find_2020_pair(){
assert_eq!(adventofcode_2020::find_2020_elements(2, adventofcode_2020::input_data::day_one::print()), 713184)
}

#[test]
fn find_2020_triplets(){
    assert_eq!(adventofcode_2020::find_2020_elements(3, adventofcode_2020::input_data::day_one::print()), 261244452)
}
