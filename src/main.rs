...
fn day6(){
    ...
    println!("The number of yes on all custom cards when all memebers must say yes is: {}", 
    adventofcode_2020::find_number_of_yeses(1, adventofcode_2020::readlines("text/day6.txt" )));
    println!("Day 6 part two took: {} ms to run", now2.elapsed().as_millis());
