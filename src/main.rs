...
fn day1(){
    println!("The product of the two items who's sum is 2020 is    :   {}", adventofcode_2020::find_2020_elements(2, input_data::day_one::print(adventofcode_2020::readlines("text/day1.txt" ))).unwrap());
    println!("The product of the three items who's sum is 2020 is  :   {}", adventofcode_2020::find_2020_elements(3, input_data::day_one::print(adventofcode_2020::readlines("text/day1.txt" ))).unwrap());
}

fn day2(){
    println!("The number of valid passwords with the old method is : {}", adventofcode_2020::valid_password("old", input_data::day_two::print(adventofcode_2020::readlines("text/day2.txt" ))));
    println!("The number of valid passwords with the old method is : {}", adventofcode_2020::valid_password("new", input_data::day_two::print(adventofcode_2020::readlines("text/day2.txt" ))));
}
fn day3(){
